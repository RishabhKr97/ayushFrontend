...
@NgModule({
  ...
  providers: [AddformService, VideoCallService, MessageService, PatientService, AppointmentService, ReceiptService, PatientRegisterService,InstituteHistoryService,InstituteRegisterService,LoginService,GlobalService],
